...
Removes type annotations for compatibility.
"""

import math

class Move:
    def __init__(self, x, y, score=0.0):
        self.x = x
        self.y = y
        self.score = score
...
class GoAIOptimized:
    ...
    def evaluate_move_heuristic(self, x, y, color):
    ...
    def evaluate_move(self, x, y, color, captures_black, captures_white, alpha, beta):
    ...
    def minimax(self, depth, is_maximizing, ai_color, captures_black, captures_white, alpha, beta):
    ...
    def evaluate_move_minimax(self, x, y, color, depth, ai_color, captures_black, captures_white, alpha, beta, next_is_max):
    ...
    def evaluate_position(self, ai_color, captures_black, captures_white):
    ...
    def simulate_captures(self, color):
    ...
    def has_liberties_fast(self, x, y):
    ...
    def _has_liberties_dfs(self, x, y, color):
    ...
    def count_group_liberties_fast(self, x, y):
    ...
    def count_all_liberties(self, color):
    ...
    def estimate_territory_fast(self, color):
    ...
    def get_point_influence_fast(self, x, y):
    ...
    def calculate_influence_fast(self, color):
